...
- Growth Strategy (GEO) → Use @arth-geo-strategist
- Agentic Commerce (ACO) → Use @arth-agentic-commerce-specialist
- Answer Engine (AEO) → Use @arth-aeo-content-architect
- E-E-A-T Audit → Use @arth-e-eat-auditor
- Copy/Storytelling → Use @arth-content-strategist
- Visual Direction → Use @arth-creative-director
- Campaign Management → Use @arth-campaign-manager
- B2B SDR → Use @arth-sdr-agent
- B2B Closer → Use @arth-closer
- Performance Analysis → Use @arth-performance-analyst
